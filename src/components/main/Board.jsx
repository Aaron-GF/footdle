          ...
          >
            ...
            {cell.type === "team" && (
              <img
                src={cell.content}
                alt="Team"
                className="size-full p-2 md:p-4 object-contain"
              />
            )}
            ...
            {cell.type === "placeholder" && (
              <Shirt className="size-full bg-green-700 text-main/40 cursor-pointer p-2 md:p-4 hover:bg-color1/20 rounded-md transition duration-200" />
            )}
          </div>
        );
      })}
